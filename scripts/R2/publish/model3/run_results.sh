...
# CSV cache: rsync the four filtered model3 CSVs here before running.
# verification.py pulls anything missing from R2 (or fails with instructions).
TMP_DIR=/tmp/model3

python ${REPO_ROOT}/scripts/R2/publish/model3/verification.py -tmp-dir ${TMP_DIR}
...
python ${SANITY} \
    ...
    -reference-csv ${TMP_DIR}/sutva_click2houston_com_2022-05-01_pair1_treated_run1_sutva_click2houston_com_2022-05-01_pair2_control_run4_filtered.csv

python ${SANITY} \
    -base-model abehandler/sutva_click2houston_com_2022-05-01_pair2_treated_run3 \
    -dataset ${DS} \
    -urls-file ${REPO_ROOT}/scripts/R2/publish/model3/sanity_check_urls.sutva.txt \
    -reference-csv ${TMP_DIR}/sutva_click2houston_com_2022-05-01_pair2_treated_run3_sutva_click2houston_com_2022-05-01_pair2_control_run4_filtered.csv

python ${SANITY} \
    -base-model abehandler/sutva_click2houston_com_2022-05-01_pair2_control_run4 \
    -dataset ${DS} \
    -urls-file ${REPO_ROOT}/scripts/R2/publish/model3/sanity_check_urls.sutva.txt \
    -reference-csv ${TMP_DIR}/sutva_click2houston_com_2022-05-01_pair2_control_run4_sutva_click2houston_com_2022-05-01_pair2_control_run4_filtered.csv