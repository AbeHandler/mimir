...
for CONFIG_FILENAME in "excluded-docs.blocks.clipped.json" "excluded-docs.noblocks.clipped.json"  "excluded-docs.blocks.bisection.json" "excluded-docs.noblocks.bisection.json"; do
