...
class Data:
    ...
    def __init__(self, name,
                 ...
                 presampled: str = None,
                 name_key_mapping: dict = {"legacy-datasets/banking77": "text", "abehandlerorg/minhashblocksample": "text", "abehandlerorg/localblockeddocs": "text", "abehandlerorg/blockeddocs": "text",  "abehandlerorg/copyrighttrapszeros": "text", "the_pile": "text", "xsum": "document", "abehandlerorg/olmobypublisherdev": "text", "abehandlerorg/copywritetraps": "text"}):
